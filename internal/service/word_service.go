...
// validateComplete enforces the project's "never persist a word with
// incomplete data" rule (docs/vocabulario_bot_documentacao.md, secao 8.2).
// It checks the fields required for the word card and the three quiz
// questions to be usable, regardless of what the AI provider returned.
